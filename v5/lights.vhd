...
------------------------------------------------
-- Start rotation
-- rotation lancée si ligne perdue
------------------------------------------------
...
------------------------------------------------
-- SELECTION ENTRE SUIVI ET ROTATION
------------------------------------------------

process(start_rot, PWMgauche_SL, PWMgauche_ROT, PWMdroit_SL, PWMdroit_ROT)
begin
...
case pos_ligne is
    when -6 => LED(5 downto 0) <= "111111";
    when -5 => LED(5 downto 0) <= "011111";
    when -4 => LED(5 downto 0) <= "001111";
    when -3 => LED(5 downto 0) <= "000111";
    when -2 => LED(5 downto 0) <= "000011";
    when -1 => LED(5 downto 0) <= "000001";
    when 0  => LED(5 downto 0) <= "000000";
    when 1  => LED(5 downto 0) <= "100000";
    when 2  => LED(5 downto 0) <= "110000";
    when 3  => LED(5 downto 0) <= "111000";
    when 4  => LED(5 downto 0) <= "111100";
    when 5  => LED(5 downto 0) <= "111110";
    when 6  => LED(5 downto 0) <= "111111";
